              ...
              tableData.map((data, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td>
                      <Link to={ITEM_DETAIL_URL(data.id)}>{data.name}</Link>
                    </td>
                    <td>{parseFloat(data.max_amount)}</td>
                    <td>{parseInt(data.quantity)}</td>
                    <td>{to_DateTime(data.bidding_end_time)}</td>
...
export default GroupBuyingItemsTable;
